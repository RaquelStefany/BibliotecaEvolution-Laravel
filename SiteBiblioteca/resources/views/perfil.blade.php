...
<head>
    ...
    <title>Perfil - Biblioteca Evolution</title>
</head>
<body>
        ...
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              @if ($email != "")
                <li><a class="getstarted scrollto" href="#">Perfil</a></li>
              @else
    ...
    <main id="main">
        ...
        <section id="team" class="team section-bg">
            <div class="wrapper fadeInDown">
                ...
                <br>
                <h1>
                  Quantos livros misteriosos deseja encomendar dessa vez?
                </h1>
                <br>
                <form action="/misterioso">
                  <input type="number" name="quantidade" placeholder="Insira a Quantidade de Livros" id="livros">
                  <br>
                  <br>
                  <input type="submit" name="quantidade" class="fadeIn fourth" value="Encomendar">
              </form>
              <br>
              @component('misterioso')
              @endcomponent
            </div>
        </section>
